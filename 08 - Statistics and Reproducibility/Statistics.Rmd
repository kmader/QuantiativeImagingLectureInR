...
icVal<-ICCbare(name,values,data=test.data)$ICC
ggplot(test.data,aes(x=name,y=values))+
  geom_point()+
...
```{r, load-metrics}
source('~/Dropbox/tipl_maven/snippets/R/shapeAnalysisProcess.R')
source('~/Dropbox/tipl_maven/snippets/R/commonReportFunctions.R')
