...
output: 
  slidy_presentation:
    footer: "Quantitative Big Imaging 2017"
---
...
```{r script_setup, cache=F, warning=FALSE, cache=FALSE,echo=FALSE,error=FALSE,results='hide'}
...
div.spiral.pts %>% sample_n(4) %>% kable
```

```{r}
ggplot(div.spiral.pts,aes(x1,y1))+
  geom_point(aes(shape=data_div,color=class),size=3)+
  labs(shape="Type")+
  theme_bw(20)
```
